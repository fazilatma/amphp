...
const taskKindLabel=k=>({scrape:'استخراج DOM',detail_extract:'جزئیات محصولات',profile_dispatch:'ارسال مقصدها',basalam_sdk:'SDK باسلام',ai_test:'آزمایش مدل‌های AI'}[k]||k||'—');
