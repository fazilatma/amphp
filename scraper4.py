      ...
      <div id="set-sub-deployer" class="settings-sub-panel" style="display:none;">
        <div class="glass-card" style="margin:0">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:10px">
            <button class="btn btn-secondary btn-sm" onclick="deployerScan()">🔍 اسکن همه برنچ‌ها</button>
          ...
          <div id="deployerTable" style="margin-top:10px;max-height:300px;overflow:auto"></div>
        </div>
      </div>
    ...
    if (table) {
      ...
      if (!rows.length) table.innerHTML = '<div class="chip">نتیجه‌ای نیست</div>';
        ...
        table.innerHTML = rows.map(r => {
          ...
          return `<div class="ai-model-row${isNewest ? ' is-master' : ''}" style="display:flex; justify-content:space-between; align-items:center; gap:8px;">
            <div style="flex:1;">
              <b>${escHtml(r.branch)}</b> <span dir="ltr" style="color:var(--primary);">${escHtml(r.version)}</span>
              ${isNewest ? '<span class="chip chip-success" style="margin-inline-start:6px;">جدیدترین ⭐</span>' : ''}
              <span class="chip" style="margin-inline-start:4px;">${toFa(Math.round(r.size/1024))}KB</span>
