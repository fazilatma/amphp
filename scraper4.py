    ...
    try:
        ...
        for destination in destinations:
            ...
            for index,product in enumerate(products,1):
                ...
                try:
                    destination_product=product_for_destination(product,profile_rules,destination)
...
<header class="hero"><div class="hero-main"><div class="logo">🕸️</div><div><div class="eyebrow">مرکز استخراج محصول</div><h1>🛒 اسکرپر <small id="appVersion">v4.3.0</small></h1><div class="sub">استخراج و مدیریت هوشمند محصولات</div></div></div><div class="hero-badge"><span>●</span> آنلاین و آماده</div></header>
