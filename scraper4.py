...
<section id="results" class="pane"><div class="card result-hero"><div><h3>📊 محصولات استخراج‌شده</h3><small>جدول کامل محصولات فقط در این تب نمایش داده می‌شود.</small></div><span id="resultCountBadge" class="badge">۰ محصول</span></div><div class="primary-actions actions"><button class="green" onclick="downloadCSV()">↓ CSV</button><button class="gray" onclick="downloadJSON()">↓ JSON</button><button class="gray" onclick="downloadXLSX()">↓ Excel</button></div><div id="resultsMount"></div></section>
